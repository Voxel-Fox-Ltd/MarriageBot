...
parser.add_argument(
    "gold_config_file", help="The configuration for the Gold version of the bot."
)
parser.add_argument(
    "--host", type=str, default="0.0.0.0", help="The host IP to run the webserver on."
)
parser.add_argument(
    "--port", type=int, default=8080, help="The port to run the webserver on."
)
...
app["gold_bot"] = utils.Bot(
    config_file=args.gold_config_file, logger=logger.getChild("goldbot")
)

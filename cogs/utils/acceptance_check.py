...
class AcceptanceCheck(object):
    ...
    PROPOSAL_YES = regex.compile(
        r"(?:i do)|(?:yes)|(?:of course)|(?:definitely)|(?:absolutely)|(?:yeah)|(?:yea)|(?:sure)|(?:accept)|(?:ya)",
        regex.IGNORECASE,
    )
    PROPOSAL_NO = regex.compile(
        r"(?:i don't)|(?:i dont)|(?:no)|(?:to think)|(?:i'm sorry)|(?:im sorry)|(?:decline)|(?:nah)",
        regex.IGNORECASE,
    )
    ...
    def __init__(
        self,
        target: typing.Union[discord.User, int],
        channel: typing.Union[discord.User, int] = None,
    ):

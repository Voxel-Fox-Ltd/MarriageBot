...
class TextValidator(object):
    ...
    def get_valid_strings(
        cls, strings: typing.List[str], provided_arguments: typing.List[str]
    ) -> typing.List[str]:
        ...
        for i in strings:
            ...
            if provided_arguments == string_has or provided_arguments.issuperset(
                string_has
            ):
                v.append(i)
        return v
...
class TextTemplate(object):
    ...
    WANTS_RANDOM_STRINGS = [
        ...
        "target_is_bot",
        "target_is_you",
        "instigator_is_instigator",
        "instigator_is_target",
        "target_is_instigator",
        "target_is_target",
        "request_timeout",
        "request_accepted",
        "request_denied",
        "target_is_unqualified",
        "instigator_is_unqualified",
    ]

    __slots__ = ("instigator", "target", "responses")

    def __init__(
        self, command: str, instigator: discord.Member, target: discord.Member
    ):

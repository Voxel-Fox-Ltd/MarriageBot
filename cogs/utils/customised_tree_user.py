...
class CustomisedTreeUser(object):
    ...
    def __init__(
        ...
        *,
        ...
        node: int = None,
        font: int = None,
        highlighted_font: int = None,
        highlighted_node: int = None,
        background: int = None,
        direction: str = "TB",
    ):
        self.id = user_id
    ...
    def hex(self) -> dict:
        ...
        if self.highlighted_font is not None:
            highlighted_font = (
                f'"#{self.highlighted_font:06X}"'
                if self.highlighted_font >= 0
                else "transparent"
            )
        else:
        ...
        if self.highlighted_node is not None:
            highlighted_node = (
                f'"#{self.highlighted_node:06X}"'
                if self.highlighted_node >= 0
                else "transparent"
            )
        else:
        ...
        if self.background is not None:
            background = (
                f'"#{self.background:06X}"' if self.background >= 0 else "transparent"
            )
        else:
